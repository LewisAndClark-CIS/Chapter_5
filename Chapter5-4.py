...
daddy={"John Smith": "James Smith",
       "James Smith": "David Smith",
       "Fred Adams": "Carl Adams",
       "Carl Adams": "Frank Adams",
       "Gary Lee": "Kal lee",
       "Kal Lee": "Tyler Lee"}
while choice != "0":
    print("""
    ...
    if choice == "0":
        ...
        granDad=input("Who's grandfather are you looking up?: ")
        if granDad in daddy:
            dad=daddy[granDad]
            print(granDad+" is grandson to "+dad+".")
        else:
            print("Error")

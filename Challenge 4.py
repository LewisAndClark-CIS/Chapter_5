"""
4. Improve the "Who's Your Daddy?" program by adding a choice that lets the user enter a name and get back a grandfather.
...
"""
############## STILL NEED TO ADD GRANDFATHER ABILITY #####################
#Andrew Hecky
#Last Edit: 11/12/14
